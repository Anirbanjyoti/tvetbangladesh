    ...
    <main className="container" style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid var(--border-color)", paddingBottom: "1.5rem" }}>
        <div>
          ...
          <h1 style={{ fontSize: "2rem", fontWeight: 800, marginTop: "0.5rem", letterSpacing: "-0.025em" }}>
            TVET Bangladesh
          </h1>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.5rem" }}>
        ...
        <div className="card">
          ...
          <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>
            Health probes: <code style={{ color: "var(--accent-cyan)" }}>/health</code>, <code style={{ color: "var(--accent-cyan)" }}>/live</code>, <code style={{ color: "var(--accent-cyan)" }}>/ready</code>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.875rem", lineHeight: 1.5, marginBottom: "1rem" }}>
            Background job worker cluster with dedicated heartbeat health probe for container orchestration.
          </p>
          <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>
            Health probe: <code style={{ color: "var(--accent-cyan)" }}>http://localhost:5001/health</code>
          </div>
        </div>
      </section>

      <footer style={{ marginTop: "auto", borderTop: "1px solid var(--border-color)", paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", color: "var(--text-muted)", fontSize: "0.875rem" }}>
